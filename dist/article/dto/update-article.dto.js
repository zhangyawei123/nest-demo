...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '文章标题', required: false }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: '文章封面图 URL', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.MaxLength)(500, { message: 'Logo URL 最多500个字符' }),
    __metadata("design:type", String)
], UpdateArticleDto.prototype, "logo", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: '文章内容（富文本 HTML）', required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
